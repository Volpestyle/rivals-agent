...
def propose_segments(intervals, hud_samples, *, ui_keys=(), controls=None, gaps=(), regime_spans=(),
    ...
    without control-affecting input (R6), capture gaps and other-regime spans. Each gameplay piece starts at its first HUD-present sample and ends one ns after its last
    HUD-present sample that precedes any cut, so both edges are verified gameplay frames (conservative).
