...
def review_for(data, segments):
    """A minimal importer review over the given segments (synthetic provenance)."""
...
def build_dataset(data, segments, *, group="g", split="train"):
    """The importer's HumanDataset for a payload and review segments."""
    data["review"] = review_for(data, segments)
    meta = data["metadata"]
