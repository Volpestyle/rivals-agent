# Learning plan history

These sections moved verbatim from [docs/learning-plan.md](../learning-plan.md) on 2026-09-23, in their original
order and at their original heading levels; only relative link targets were re-rooted for this folder. They record
finished, parked or superseded work. The live plan keeps stub headings for the sections other docs link to, the
glyph contract (cited by `perception/hud.py`) and the roadmap diagram that used to sit at the end of the B0 section.

*From `## First visible learned range milestone (2026-09-22)`: `docs/learning-plan.md` lines 42-215 at `b4b49d2`.*
...
*From `## Roadmap and advancement gates`: `docs/learning-plan.md` lines 323-921 at `b4b49d2`.*
...
*From `## Roadmap and advancement gates`: `docs/learning-plan.md` lines 1011-1272 at `b4b49d2`.*
...
*From `## Data and labels`: `docs/learning-plan.md` lines 1345-1708 at `b4b49d2`.*
...
*From `## Data and labels > ### E enablers: bounded offline pilots`: `docs/learning-plan.md` lines 1716-2022 at `b4b49d2`.*
...
*From `## Sources`: `docs/learning-plan.md` lines 2284-2429 at `b4b49d2`.*
