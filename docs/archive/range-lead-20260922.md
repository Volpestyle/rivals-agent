...
> **Archived 2026-09-23** from `docs/lanes/range-lead.md`. It is verbatim except for this note and two links
> re-pointed for the new folder. This was the 2026-09-22 lead diary. The range work's present state and the index of
> the range notes are in [docs/lanes/range-lead.md](../lanes/range-lead.md).
...
independently, under [the event contract](../lanes/range-policy-reframe.md). Its changed
...
replace VUH-1347. The [accepted focus/deadline caller](../lanes/range-live-focus.md)
