...
| **S4** self-fed share of steps with any live hold on, against the human's | `any_hold_share` against `human_any_hold_share` (0.699 on this dev) |
...
| S4 | `any_hold_share` in **[0.5, 1.3] × `human_any_hold_share`** ([0.35, 0.91] on this dev) | idle (0) and latched (1.0, twin seed 2) |
