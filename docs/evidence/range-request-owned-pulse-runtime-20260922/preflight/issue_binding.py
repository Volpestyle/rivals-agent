...
decision = {
    ...
    'experiment_question': 'Measure fresh request starts and fixed owned pulse completion under request-start-owned-pulse-v1, with exact-output HUD candidate filtering; preserve all proposals/refusals/returns/releases in one exploratory phase',
    ...
    'scope': {'run_name': 'range-request-owned-pulse-20260922-1', 'run_count': 1,
    ...
    'limits': ['One source event/four negative labels; TRAIN-only fit, independent quality unknown',
               ...
               'Fourth named software diagnostic after reviewed owned-pulse execution interpretation and exact-output HUD candidate filter; not independent quality or a retry of any consumed binding',
