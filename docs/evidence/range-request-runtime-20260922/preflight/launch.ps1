...
$runtime = 'C:\Users\volpe\repos\rivals-agent\data\runtime\range-request-preflight-20260922'
$liveTree = 'C:\Users\volpe\repos\rivals-agent-live'
$runDir = 'C:\Users\volpe\repos\rivals-agent\data\l1\range-request-diagnostic-20260922-1'
...
$run = Start-Process -FilePath 'C:\Users\volpe\AppData\Local\Programs\Python\Python311\Scripts\uv.exe' -WorkingDirectory $liveTree -WindowStyle Hidden -ArgumentList 'run --offline --no-project --python 3.11 --with dxcam --with vgamepad --with opencv-python-headless --with pillow --with torch python -m agent.loop --live --brain range-skill --game-pid 48460 --max-s 10 --cooldowns normal --no-scoreboard --run range-request-diagnostic-20260922-1 --range-checkpoint C:\Users\volpe\repos\rivals-agent\data\diagnostics\range-request-human-fit-20260922\run-1\model.pt --range-sha256 6ee388070599e3df042ea73876e391340bf228a9e626cc212c60875d8191aeef --range-identity C:\Users\volpe\repos\rivals-agent\data\runtime\range-request-preflight-20260922\source-identity.json --range-runtime C:\Users\volpe\repos\rivals-agent\data\runtime\range-request-preflight-20260922\runtime-identity.json --range-deployment C:\Users\volpe\repos\rivals-agent\data\runtime\range-request-preflight-20260922\deployment-binding.json' -RedirectStandardOutput (Join-Path $runtime 'learned.log') -RedirectStandardError (Join-Path $runtime 'learned.err') -Wait -PassThru
...
Screenshot 'C:\desk\out\range-request-learned-after.png'