...
| `range-bc-countermeasures-2-20260926/` | VUH-1346 | Countermeasures round 2: the lead-approved pre-registration (4d4576db) and brief, pinned before launch; results land here | current | nothing yet |
...
| `changed-boundary-reviews-20260926/` | VUH-1346 | fit-review's verbatim review of countermeasures round 2 (known-idle corruption D, sequential self-conditioning E; verdict: land with one fix, re-reviewed: land) with hud-review's hand-backs | historical | nothing outside evidence |
| `sealed-takes-20260926/` | VUH-1359, VUH-1353 | The 2026-09-26 test take sealed (denylist v2 with allowed_split), Gate 2 pair 2 sealed, the Heart of Heaven replay and left-turn calibration registered; admission-review FIX then LAND | current | `lanes/human-admission.md` |
| `sealed-takes-20260926-tally/` | VUH-1359 | tally.py defaults to a snapshot that validates the v2 registry; review LAND | current | `lanes/human-admission.md` |
| `gate2-revalidation-20260926/` | VUH-1353 | The Gate 2 readers' one re-validation (seed 20260927): kill feed FAILS (K1 0.18; a competitive live HUD's team clock read as the replay viewer) and is kept as a failed experiment; match timer T1 passes, T2/T3' undecided (69 < 100), replay undecided; fit-review: timer lands as a value reader only | current | `lanes/inverse-dynamics.md` |
| `reader-validation-20260926/` | VUH-1353 | Two 2026-09-25 matches (21-13-21, 22-48-05) move from match_dev to reader_validation for the Gate 2 readers' one re-validation; review LAND | current | `lanes/inverse-dynamics.md` |
