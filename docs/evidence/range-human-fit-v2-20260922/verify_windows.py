...
assert hashlib.sha256((OUT / "mac-report.json").read_bytes()).hexdigest() == "5cd1e957975cd2842f53866ac7e97b30796e7ba2434a98b6242c47a9cb479bcc"
assert mac["checkpoint_sha256"] == "da29a97f0542210e6c69bc7dfa488afec97c33668a27deea98e3177919834987"
...
packet = json.loads((ROOT / "data/human/skill-events/032454-train-diagnostic-v2/examples.json").read_text())
examples = []
