...
- **Controls:**
  ...
  - the two inside the pitch sweeps (27.6 s and 36.4 s: pitched views, 70 and 276 inliers) read −0.134° and +0.038°, so
    the script's `controls_ok` is **false** for those two;
