...
from policy.range_skill_policy import (
    SourceIdentity, Snapshot, RequestExample, cohort, evidence_digest,
...
assert hashlib.sha256((OUT / "mac-report.json").read_bytes()).hexdigest() == "9d763f7c8e2c26e61174ff950fdc5ddefd268f3e22df8d900e11ce17f9b47638"
assert mac["checkpoint_sha256"] == "6ee388070599e3df042ea73876e391340bf228a9e626cc212c60875d8191aeef"
...
packet = json.loads((ROOT / "data/human/skill-events/032454-request-diagnostic-v1/examples.json").read_text())
examples = []
...
assert delta < 1e-5
metrics = event_metrics(examples, names, model.spec, semantic_revision=source.semantic_revision)
